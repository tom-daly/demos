...
<asp:Content ContentPlaceholderId="PlaceHolderAdditionalPageHead" runat="server">
    ...
    <SharePointWebControls:CssRegistration name="<% $SPUrl:~siteCollection/Style Library/sps/css/home-page.css %>" After="<% $SPUrl:~siteCollection/Style Library/sps/css/base.css %>" runat="server"/>
</asp:Content>
...
<asp:Content ContentPlaceholderId="PlaceHolderMain" runat="server">
    <!-- Home Page Layout 1/22/2017 -->
	<div class="welcome blank-wp home-page-layout">
		<PublishingWebControls:EditModePanel runat="server" CssClass="edit-mode-panel title-edit">
			<SharePointWebControls:TextField runat="server" FieldName="Title"/>
		</PublishingWebControls:EditModePanel>
        
        <div class="table full-width m0 top-table">
            <div class="table-row">
                <div class="table-cell">
                    <WebPartPages:WebPartZone runat="server" Title="Top" ID="Top" />
                </div>
            </div>
        </div>
        
        <div class="p0">
           <div class="table full-width m0 middle-table">
            <div class="table-row">
                <div class="table-cell align-top">
                    <div class="left-cell">
                        <WebPartPages:WebPartZone runat="server" Title="Middle Left" ID="MiddleLeftColumn" />    
                    </div>
                </div>
                <div class="table-cell align-top">
                    <div class="middle-cell">
                        <WebPartPages:WebPartZone runat="server" Title="Middle Center" ID="MiddleCenterColumn" />
                    </div>
                </div>
                <div class="table-cell align-top">
                    <div class="right-cell">
                        <WebPartPages:WebPartZone runat="server" Title="Middle Right" ID="MiddleRightColumn" />    
                    </div>
                </div>
            </div>
        </div>         
