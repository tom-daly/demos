...
import styles from './HelloWorldJQuery1E.module.scss';
import { IHelloWorldJQuery1EProps } from './IHelloWorldJQuery1EProps';
import { escape } from '@microsoft/sp-lodash-subset';
import * as jQuery from "jquery";
import "jqueryui";
import { SPComponentLoader } from "@microsoft/sp-loader";

export default class HelloWorldJQuery1E extends React.Component<IHelloWorldJQuery1EProps, {}> {
  public constructor() {
    super();
  ...
  public render(): React.ReactElement<IHelloWorldJQuery1EProps> {
    return (
