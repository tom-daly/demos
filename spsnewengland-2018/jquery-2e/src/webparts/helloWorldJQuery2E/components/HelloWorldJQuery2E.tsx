...
import styles from './HelloWorldJQuery2E.module.scss';
import { IHelloWorldJQuery2EProps } from './IHelloWorldJQuery2EProps';
import { escape } from '@microsoft/sp-lodash-subset';
import * as jQuery from "jquery";
import "jqueryui";
import { SPComponentLoader } from "@microsoft/sp-loader";

export default class HelloWorldJQuery2E extends React.Component<IHelloWorldJQuery2EProps, {}> {
  public constructor() {
    super();
  ...
  public render(): React.ReactElement<IHelloWorldJQuery2EProps> {
    return (
